        ...
        <td class='td01'>
            ...
            if($CODIGO<>"")
            {
                ...
                while($exibe_ciclos = mysqli_fetch_array($banco)) { 
                    ...
                    echo "<p class='texto'><b>Data final para Produtores ofertarem produtos:</b><br><input type='text' class='texto' size='10'  maxlength='10' name='data-fim-produtores' value='".$exibe_ciclos["Data-fim-produtores"]."'></p>";
                    echo "<p class='texto'><b>Data inicial para Consumidores realizarem pedido:</b><br><input type='text' class='texto' size='10'  maxlength='10' name='data-inicio-consumidores' value='".$exibe_ciclos["Data-inicio-consumidores"]."'></p>";
                    echo "<p class='texto'><b>Data final para Consumidores realizarem pedido:</b><br><input type='text' class='texto' size='10'  maxlength='10' name='data-fim-consumidores' value='".$exibe_ciclos["Data-fim-consumidores"]."'></p>";
