    ...
    <tr>
            <td>
                ...
                if($pagina > 1) {
                    ...
                    echo "<a href='index.php?pagina=".($pagina - 1)."' class='controle'><button>CICLOS ANTERIORES</button></a>"; 
                }
                ...
                if($pagina < $numPaginas) {
                    ...
                    echo "<a href='index.php?pagina=".($pagina - 1)."' class='controle'><button>EXIBIR PRÓXIMOS CICLOS</button></a>";
                }
                mysqli_close($conn);
                ?>
            </td>
