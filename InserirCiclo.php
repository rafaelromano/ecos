    ...
    <tr>
        <td class='td01'>
           ...
           // $CODIGO = $_POST['codigo'];
            ...
            mysqli_query($conn, "INSET INTO 'ecos'.'Ciclos' (Data-inicio-geral,Hora-inicio-geral,
            Data-fim-geral,Hora-fim-geral,Data-inicio-produtores,Data-fim-produtores,Data-inicio-consumidores, 
            Data-fim-consumidores,Titulo-ciclo-aberto,Texto-complementar-título,Texto-dicas,Texto-ciclo-fechado,
            URL-produtores,Texto-confirma-ofertas,Texto-confirma-pedido-produtores,URL-consumidores,
            Texto-confirma-pedido-consumidores,URL-administradores,Situacao) VALEUS ($datainiciogeral,$horainiciogeral,
            $datafimgeral,$horafimgeral,$datainicioprodutores,$datafimprodutores,$datainicioconsumidores,$datafimconsumidores,
            $titulocicloaberto,$textocomplementartítulo,$textodicas,$textociclofechado,$urlprodutores,$textoconfirmaofertas,
            $textoconfirmapedidoprodutores,$urlconsumidores,$textoconfirmapedidoconsumidores,$urladministradores,$situacao)");
